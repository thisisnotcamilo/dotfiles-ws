...
(gtk_accel_path "<Actions>/terminal-widget/shift-pagedown" "<Primary>bracketright")
; (gtk_accel_path "<Actions>/terminal-window/show-toolbar" "")
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "")
(gtk_accel_path "<Actions>/terminal-window/zoom-in" "<Alt>equal")
...
(gtk_accel_path "<Actions>/terminal-widget/shift-pageup" "<Primary>bracketleft")
